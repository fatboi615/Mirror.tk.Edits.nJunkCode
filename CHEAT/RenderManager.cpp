...
void Render::Initialise()
{
	...
	Interfaces::Surface->SetFontGlyphSet(Fonts::otheresp, "Calibri", 14, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::indicator, "Arial", 20, 650, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::icons, "Arial", 18, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW); // "badcache" for icons
	Interfaces::Surface->SetFontGlyphSet(Fonts::menushit, "Verdana", 19, 550, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	Interfaces::Surface->SetFontGlyphSet(Fonts::MenuText, "", 16, 500, 0, 0, FONTFLAG_ANTIALIAS);
	dwqhfuiwehfuiewgbfrendera();
