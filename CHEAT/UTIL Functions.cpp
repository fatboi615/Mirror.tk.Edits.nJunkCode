...
bool GameUtils::IsKnife(void* weapon)
{
	...
	CBaseCombatWeapon *pWeapon = (CBaseCombatWeapon*)weapon;
	int id = *pWeapon->m_AttributeManager()->m_Item()->ItemDefinitionIndex();
	static const std::vector<int> v = { WEAPON_KNIFE_KARAMBIT, WEAPON_KNIFE_PUSH, WEAPON_KNIFE_BUTTERFLY, WEAPON_KNIFE_BOWIE, WEAPON_KNIFE_TACTICAL, WEAPON_KNIFE_M9_BAYONET, WEAPON_KNIFE_T, WEAPON_KNIFE_FALCHION, WEAPON_KNIFE_CT, WEAPON_KNIFE_BAYONET, WEAPON_KNIFE_FLIP, WEAPON_KNIFE_GUT };
	return (std::find(v.begin(), v.end(), id) != v.end());
}
